...
public class LayoutVisitor implements ActualParameterVisitor<Void, DrawingTree>,
	...
	public DrawingTree visitIfCommand(IfCommand ast, Void obj) {
		...
		var d2 = ast.C1.visit(this, null);
		var d3 = ast.C2.visit(this, null);
